...
def main() -> None:
    ...
    story.append(p("작성자: Fin analytics 프로젝트 · 자료 기준: 2021-2023년 국내 IPO 사례", styles["affil"]))
    ...
    story.append(
        p(
            ...
            "두산로보틱스, 크래프톤의 상장 이벤트이며, 각 사건에 대해 동일 산업 peer 기업과 시장지수의 반응을 "
            ...
            "하락 가설이 지지되었다. 반면 두산로보틱스와 크래프톤 사례에서는 일부 peer 기업이 양(+)의 CAR을 보여 "
    ...
    story.append(
        p(
            ...
            "LG에너지솔루션, 두산로보틱스, 크래프톤은 각각 2차전지, 로봇, 게임 산업에서 투자자 관심이 높았던 "
    ...
    case_table = [
        ...
        ["크래프톤", "2021-08-10", "게임", "Krafton", "NCSoft, Netmarble, Pearl Abyss"],
    ]
    ...
    story.append(
        p(
            ...
            "지지한다. 두산로보틱스와 크래프톤 사례에서는 시장지수는 하락했지만 일부 peer 기업의 CAR이 양(+)으로 "
    ...
    story.append(
        p(
            ...
            "상대적 매력도를 낮추는 경로이다. 두산로보틱스와 크래프톤 사례에서 혼합 결과가 나타난 것은 이 두 효과가 "
